...
git clone http://github.com/gmarik/vundle.git ~/.config/nvim/bundle/vundle
cd ~/.config/nvim/bundle && \
    git clone --depth=1 https://github.com/vim-syntastic/syntastic.git
git clone https://github.com/pangloss/vim-javascript.git ~/.config/nvim/bundle/vim-javascript
